                            ...
                            <div className="flex items-center justify-between h-16">
                                ...
                                <div>
                                    <div className="group relative">
                                        ...
                                        <span id="dropdownDefaultButton" data-dropdown-trigger="{hover|click}" className="text-white bg-black hover:bg-black font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-black dark:hover:bg-black dark:focus:ring-black focus:ring-2 focus:ring-black focus:outline-none" type="button">
                                        ...
                                        <div id="dropdown" className="z-10 absolute hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 group-hover:block">
                            ...
                            <div className="flex items-center justify-between h-16">
                                ...
                                <div>
                                    <div className="group relative">
                                        ...
                                        <span id="dropdownDefaultButton" data-dropdown-trigger="{hover|click}" className="text-white bg-black hover:bg-black font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-black dark:hover:bg-black dark:focus:ring-black focus:ring-2 focus:ring-black focus:outline-none" type="button">
                                            Administrador: {userData.name} <svg className="w-2.5 h-2.5 ml-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6"><path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" /></svg>
                                        </span>
